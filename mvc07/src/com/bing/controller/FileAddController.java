...
public class FileAddController implements BasicController {
	...
	public String requestHandler(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			// request안에 있는 파일정보들을 가져올 수 있음
			List<FileItem> items = upload.parseRequest(request); // request안에 여러개 파일이 업로드 된 경우
